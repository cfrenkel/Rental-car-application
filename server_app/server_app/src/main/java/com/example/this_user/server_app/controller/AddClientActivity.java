        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  Long id = Long.valueOf(idText.getText().toString());
                ...
                if(firstName==null)
                    Toast.makeText(getApplicationContext(), "kukuku", Toast.LENGTH_SHORT);
                ...
                if (!firstNameText.getText().toString().matches("") && !lastNameText.getText().toString().matches("")
                    ...
                    try {
                        if (!backEnd.customerExist(c)) {
                             ...
                             */
                            AlertDialog mess = new AlertDialog.Builder(AddClientActivity.this).create();
                            mess.setIcon((R.drawable.ic_action_smile));
                            mess.setTitle(R.string.welcome);
                            mess.setMessage(getResources().getString(R.string.client_successfully_added));
                            //return home
